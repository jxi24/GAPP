      ...
      open (20,file='221chi2/mt_SM/chi2_mt_MODELNAME.out', status='unknown')
      open (21,file='221chi2/mt_SM/mt_MODELNAME.out',      status='unknown')
      ...
      do 10 i = 0, mtSteps
         ...
         open (5,file='221chi2/mt_SM/plot_MODELNAME.dat',status='old')
