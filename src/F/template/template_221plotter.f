...
C -------------------------------------------------------------
      ...
      open (9,file='../221plots/grid_MODELNAME_XXX.dat', status='unknown')
      open (20,file='../221plots/plot_MODELNAME_XXX.out',status='unknown')
C     open (21,file='221plots/plot_MODELNAME_2_XXX.out', status='unknown')
...
C FIND BOUNDARIES FOR fitx CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      if (scnlnx.eqv..true.) then
         ...
         do 10 i = 0, xsteps
            ...
            open (5,file='../221plots/plot_MODELNAME_XXX.dat')
