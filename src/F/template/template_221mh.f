      ...
      open (20,file='221chi2/mh_SM/chi2_MODELNAME.out',status='unknown')
      open (21,file='221chi2/mh_SM/mh_MODELNAME.out',status='unknown')
      ...
      do 10 i = 0, lnSteps
         ...
         open (5,file='221chi2/mh_SM/plot_MODELNAME.dat',status='old')
         call minuit(fcn,chi2)
         close (5)
